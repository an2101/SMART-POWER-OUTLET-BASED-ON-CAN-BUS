...
osThreadId relay1TaskHandle;
QueueHandle_t uartQueue, canQueue;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_Task_UART_Receive */
/**
...
/* USER CODE BEGIN Header_Task_CAN_Send */
/**
...
/* USER CODE BEGIN Header_Task_Relay1_Control */
/**
* @brief Function implementing the relay1Task thread.
* @param argument: Not used
* @retval None
*/
